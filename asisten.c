	...
	do{
			...
			if(c!='q' && c!='Q'){
				do{
					...
					if((a[mg][hr][0].satu==c||a[mg][hr][0].dua==c||a[mg][hr][1].satu==c||a[mg][hr][1].dua==c||a[mg][hr][2].satu==c||a[mg][hr][2].dua==c||a[mg][hr][3].satu==c||a[mg][hr][3].dua==c)){
						printf("sudah terdapat asisten tersebut disalah satu ruangan\n");}
			}while((a[mg][hr][0].satu==c||a[mg][hr][0].dua==c||a[mg][hr][1].satu==c||a[mg][hr][1].dua==c||a[mg][hr][2].satu==c||a[mg][hr][2].dua==c||a[mg][hr][3].satu==c||a[mg][hr][3].dua==c));
				if(strcmp(b[mg][hr][rg].matkul,"0")==0){printf("tidak ada jadwal pada hari,minggu,dan ruangan itu\n");}
					...
					case 'D':
						if((hr!=2)&&(hr !=0) && (strcmp(b[mg][hr][rg].matkul,"EL2205")==0)){
							...
							printf("Jadwal Asisten Praktikum Doni tidak sesuai (libur pada hari Senin)\n");
